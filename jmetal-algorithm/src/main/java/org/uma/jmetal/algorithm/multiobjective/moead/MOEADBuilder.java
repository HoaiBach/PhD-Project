...
public class MOEADBuilder implements AlgorithmBuilder<AbstractMOEAD<DoubleSolution>> {
 public enum Variant {MOEAD, ConstraintMOEAD, MOEADDRA, MOEADSTM, MOEADREF, MOEADDYN} ;
...
//  }
  ...
  public MOEADBuilder setMaxIterations(int maxIterations){
  ...
  public AbstractMOEAD<DoubleSolution> build() {
    ...
    if (moeadVariant.equals(Variant.MOEAD)) {
      algorithm = new MOEAD(problem, populationSize, resultPopulationSize, maxIterations, mutation,
      ...
      algorithm =  new ConstraintMOEAD(problem, populationSize, resultPopulationSize, maxIterations, mutation,
          crossover, functionType, dataDirectory, neighborhoodSelectionProbability,
          maximumNumberOfReplacedSolutions, neighborSize);
    } else if (moeadVariant.equals(Variant.MOEADDRA)) {
      algorithm =  new MOEADDRA(problem, populationSize, resultPopulationSize, maxIterations, mutation,
          crossover, functionType, dataDirectory, neighborhoodSelectionProbability,
          maximumNumberOfReplacedSolutions, neighborSize);
    } else if (moeadVariant.equals(Variant.MOEADSTM)) {
        algorithm =  new MOEADSTM(problem, populationSize, resultPopulationSize, maxIterations, mutation,
                crossover, functionType, dataDirectory, neighborhoodSelectionProbability,
                maximumNumberOfReplacedSolutions, neighborSize);
    } else if (moeadVariant.equals(Variant.MOEADREF)){
    	algorithm = new MOEADREF(problem, populationSize, resultPopulationSize, maxIterations, crossover,
    			mutation, functionType, dataDirectory, neighborhoodSelectionProbability,
    			maximumNumberOfReplacedSolutions, neighborSize);
    }else if (moeadVariant.equals(Variant.MOEADDYN)){
    	algorithm = new MOEADDYN(problem, populationSize, resultPopulationSize, maxIterations, crossover,
    			mutation, functionType, dataDirectory, neighborhoodSelectionProbability,
    			maximumNumberOfReplacedSolutions, neighborSize);
    }
